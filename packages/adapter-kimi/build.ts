// Bundles the Kimi hook entry and the installer into self-contained files under
// dist/. Kimi runs the hook via `bun dist/hook.js <mode>`. Paths resolve relative
// to this file so it works from any cwd.
